 ...
 * @author Touhidul_MTI
 */
//Authority can manage library books
public class ManageLibraryBookList {
    private String libraryBookId, libraryBookName,libraryBookAuthorName,libraryShelfId,bookCategory;
    
    public ManageLibraryBookList(){
        this.libraryBookId = "";
    ...
    public ManageLibraryBookList(String libraryBookId, String libraryBookName, String libraryBookAuthorName, String libraryShelfId, String bookCategory){
